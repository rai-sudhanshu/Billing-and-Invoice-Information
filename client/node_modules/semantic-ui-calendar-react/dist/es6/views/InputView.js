...
var InputView = /** @class */ (function (_super) {
    ...
    InputView.prototype.render = function () {
        ...
        var inputElement = (React.createElement(FormInputWithRef, __assign({}, rest, { readOnly: readOnly, icon: icon, iconPosition: icon && iconPosition !== 'right' ? iconPosition : undefined, innerRef: function (e) { _this.inputNode = e; onMount(e); }, value: value, tabIndex: tabIndex, inline: inlineLabel, onClear: function (e) { return (onClear || onChange)(e, __assign({}, rest, { value: '' })); }, onFocus: function (e) {
