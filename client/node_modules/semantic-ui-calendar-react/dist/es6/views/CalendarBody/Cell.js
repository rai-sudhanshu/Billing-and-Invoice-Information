...
var Cell = /** @class */ (function (_super) {
    ...
    Cell.prototype.render = function () {
        ...
        return (React.createElement(Table.Cell, __assign({}, rest, { style: cellStyle, onMouseOver: this.onCellHover, onClick: this.onCellClick }), (marked && !rest.disabled) ? React.createElement(Label, { circular: true, color: markColor, key: content }, content) : content));
    };
    return Cell;
}(React.Component));
export default Cell;
